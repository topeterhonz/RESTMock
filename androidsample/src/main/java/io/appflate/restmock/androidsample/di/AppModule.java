...
import io.appflate.restmock.recording.RESTMockRecordingInterceptor;
...
@Module public class AppModule {
  ...
  @Provides @Singleton GithubApi provideRestService(OkHttpClient okHttpClient) {
  ...
  @Provides @Singleton OkHttpClient provideOkHttpClient() {
    return new OkHttpClient.Builder().addInterceptor(
        new RESTMockRecordingInterceptor("192.168.1.147:3000")).build();
  }
}
